            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>DodoMall Board Insert<small>게시판 글 수정</small></h3>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col다-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>게시판 글 수정<small>vue.js 를 이용한 게시판 프로젝트</small></h2>
        ...
        methods:
            {
                boardUpdate:function(){
                    ...
                    // 저장된 this를 _this 변수에 할당
                    var _this = this;

                    //전송
                    axios.get("http://localhost:8080/boardList/boardView/boardUpdate/boardUpd", {
                        //값 채워주기
                        params: {
                        ...
                        location.href = '../boardView?seq=' + _this.seq;
                    })
                }
            }
    })
